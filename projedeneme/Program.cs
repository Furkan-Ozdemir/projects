             ...
             while (conditionR)
             {
                 ...
                 if (cki.Key == ConsoleKey.RightArrow)
                 {
                     ...
                     { // burası modifiye edilecek daha sonra düşman taşa göre
                         ...
                         if (board[(cursory / 2), (((cursorx - 5) / 5) - 1), 1] == 'r')
                         {
                             board[(cursory / 2), ((cursorx / 5) - 1), 1] = 'r';
                             Console.SetCursorPosition(cursorx, cursory);
                             Console.ForegroundColor = ConsoleColor.Red;
                     ...
                     if (board[(cursory / 2), ((cursorx / 5) - 1) + 1] != '.')
                     {
                 ...
                 if (cki.Key == ConsoleKey.DownArrow)
                 {
                     if (board[(cursory / 2) + 1, ((cursorx / 5) - 1)] == '.')
                     { // aşağısında nokta varsa
                         cursory += 2;
                         Console.SetCursorPosition(cursorx, cursory);
                         Console.SetCursorPosition(cursorx, cursory - 2);
                     ...
                     else if (board[(cursory / 2) + 1, ((cursorx / 5) - 1)] != '.')
                     {
                         Console.SetCursorPosition(cursorx, cursory);
                         Console.Write(board[(cursory / 2), ((cursorx / 5) - 1)]);
                         Console.SetCursorPosition(cursorx, cursory);
         ...
         public static void moveBishop()
         {
             while (conditionR)
             {
                 ...
                 { // sol çapraza hareket. sol çapraz noktaysa ilerle --- 1 üst 1 sol ---.
                     if (board[(cursory / 2) - 1, ((cursorx / 5) - 1) - 1] == '.')
                     { // 
                         cursory -= 2;
                         Console.SetCursorPosition(cursorx, cursory);
                         Console.SetCursorPosition(cursorx, cursory + 2);
                         ...
                         cursorx -= 5;
                         Console.SetCursorPosition(cursorx, cursory);
                         board[(cursory / 2), ((cursorx / 5) - 1)] = 'B';
                         Console.Write(board[(cursory / 2), ((cursorx / 5) - 1)]);
                         Console.SetCursorPosition(cursorx, cursory);

                     }
                     else if (board[(cursory / 2) - 1, ((cursorx / 5) - 1) - 1] != '.')
                     {
                         Console.SetCursorPosition(cursorx, cursory);
                         Console.Write(board[(cursory / 2), ((cursorx / 5) - 1)]);
                         Console.SetCursorPosition(cursorx, cursory);
